...
public class DashRendererBuilder implements RendererBuilder {
    ...
    public void buildRenderers(ExoPlayerDelegate player, RendererBuilderCallback callback) {
        currentAsyncBuilder = new AsyncRendererBuilder(context, userAgent, url, drmCallback, player, callback);
    ...
    private static final class AsyncRendererBuilder
        ...
        private final ExoPlayerDelegate player;
        ...
        public AsyncRendererBuilder(Context context, String userAgent, String url,
                                    MediaDrmCallback drmCallback, ExoPlayerDelegate player, RendererBuilderCallback callback) {
            this.context = context;
            this.userAgent = userAgent;
            this.drmCallback = drmCallback;
            this.player = player;
        ...
        private void buildRenderers() {
            ...
            if (hasContentProtection) {
                ...
                try {
                    drmSessionManager = StreamingDrmSessionManager.newWidevineInstance(
                            player.getMainHandler().getLooper(), drmCallback, null, player.getMainHandler(), player);
            ...
            ChunkSource videoChunkSource = new DashChunkSource(manifestFetcher,
                    ...
                    elapsedRealtimeOffset, mainHandler, player, ExoPlayerDelegate.TYPE_VIDEO);
            ...
            ChunkSource audioChunkSource = new DashChunkSource(manifestFetcher,
                    ...
                    elapsedRealtimeOffset, mainHandler, player, ExoPlayerDelegate.TYPE_AUDIO);
            ChunkSampleSource audioSampleSource = new ChunkSampleSource(audioChunkSource, loadControl,
                    AUDIO_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player,
                    ExoPlayerDelegate.TYPE_AUDIO);
            TrackRenderer audioRenderer = new MediaCodecAudioTrackRenderer(audioSampleSource,
                    MediaCodecSelector.DEFAULT, drmSessionManager, true, mainHandler,
            ...
            ChunkSource textChunkSource = new DashChunkSource(manifestFetcher,
                    ...
                    elapsedRealtimeOffset, mainHandler, player, ExoPlayerDelegate.TYPE_TEXT);
            ChunkSampleSource textSampleSource = new ChunkSampleSource(textChunkSource, loadControl,
                    TEXT_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player,
                    ExoPlayerDelegate.TYPE_TEXT);
