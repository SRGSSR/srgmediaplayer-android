...
public final class SystemUiHelper {
     ...
     */
    public SystemUiHelper(AppCompatActivity activity, int level, int flags) {
     ...
     *         {@link ch.srg.mediaplayer.extras.fullscreen.helper.SystemUiHelper} was instantiated with.
     */
    ...
    /**
     * Show the system UI. What this means depends on the mode this {@link ch.srg.mediaplayer.extras.fullscreen.helper.SystemUiHelper} was
     * instantiated with.
     *
    ...
    /**
     * Hide the system UI. What this means depends on the mode this {@link ch.srg.mediaplayer.extras.fullscreen.helper.SystemUiHelper} was
     * instantiated with.
     *
     * <p>Any currently queued delayed hide requests will be removed.
     */
    ...
    static abstract class SystemUiHelperImpl {
        ...
        SystemUiHelperImpl(AppCompatActivity activity, int level, int flags,
    ...
    static class SystemUiHelperImplBase extends SystemUiHelperImpl {
        ...
        SystemUiHelperImplBase(AppCompatActivity activity, int level, int flags,
                OnVisibilityChangeListener onVisibilityChangeListener) {
